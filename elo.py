...
def train_test(num_rows=None):
    ...
    # load csv
    train_df = pd.read_csv('../../data/ELO/train.csv', index_col=['card_id'], nrows=num_rows)
    test_df = pd.read_csv('../../data/ELO/test.csv', index_col=['card_id'], nrows=num_rows)
...
def historical_transactions(num_rows=None):
    # load csv
    hist_df = pd.read_csv('../../data/ELO/historical_transactions.csv', nrows=num_rows)
...
def new_merchant_transactions(num_rows=None):
    # load csv
    new_merchant_df = pd.read_csv('../../data/ELO/new_merchant_transactions.csv', nrows=num_rows)
